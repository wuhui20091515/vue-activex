...
export default {oframe,isOpened,CheckFileOpened,OnDocumentOpened,OnDocumentClosed,ToggleMenubar,ToggleRibbonBar,ToggleTitlebar,ToggleToolbars,NewDoc,OpenDoc,SaveCopyDoc,
ChgLayout,PrintDoc,OpenProperty,CloseDoc,CheckControlInstall,AddNewWord,OpenLocalWord,OpenWebWord,SetUserName,ToggleAllRevisions,ProtectDoc,UnProtectDoc,SetViewMode,
SetPageFit,CopyWithoutFormat,InsertPicture,GetBookmarksCount,BookmarksContent,AddNewExcel,AddNewPPT,UploadWord,DownloadWord}
